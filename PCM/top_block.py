...
# Title: Top Block
# Generated: Tue Nov  3 22:50:21 2015
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps((filter.firdes.low_pass(1, self.samp_rate, self.data_rate/2 * 1.1, transition_width = 2 * self.data_rate/2 * 1.1, window=filter.firdes.WIN_BLACKMAN)))
